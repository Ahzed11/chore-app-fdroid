...
| --- | --- | --- | --- |
| <a href="https://github.com/Ahzed11/chore-app"><img src="fdroid/repo/icons/" alt="ChoreApp icon" width="36px" height="36px"></a> | [**ChoreApp**](https://github.com/Ahzed11/chore-app) | Vibe-coded chore management app. Made for self-hosting. Use at your own risk. | 1.0.4 (10004) |
<!-- end apps table -->
